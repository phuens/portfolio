...
export default function TIL() {
    ...
    const Jumbotron = ({ data }) => {
        return (
            <div className="border p-4 md:p-4 rounded-xl bg-white text-blue-900">
                ...
                <hr />
                <p className="text-md my-2 text-gray-700">{data.content}</p>
                <hr />
                        ...
                        <div className="text-xs text-gray-400">
                            ...
                            {data.source ? (
                                <a
                                    ...
                                    aria-disabled={data.link === '#'}
                                >
                                    {data.source}
                                </a>
                            ) : (
                                <i className="text-gray-200">NA</i>
                            )}
                        </div>
                    </div>
                </div>
    ...
    return (
        <>
                                    ...
                                    >
                                        <p className="text-md text-center mb-16 md:mb-20 text-white md:text-2xl">
                                            <button
                                                ...
                                                style={{
                                                    boxShadow:
                                                        '1px 1px 1px #000, -1px -1px 3px #090c16',
                                                }}
                                        ...
                                        <form className="flex flex-col px-4">
                                            <div className="flex flex-row flex-wrap md:justify-between my-2">
                                                ...
                                                <div className=" w-full md:w-6/12 flex flex-col">
                                                    <label className="text-white my-2">
                                                        <input
                                                            onChange={handleChange}
                                                            className="p-2 float-right text-black w-full md:w-11/12 rounded-sm"
                                                            name="date"
                                                            type="date"
                                                        />
                                                    </label>
                                            ...
                                            <div className="flex flex-row flex-wrap w-full">
                                                ...
                                                <div className="flex flex-wrap w-full md:w-12/12">
                                                    <label className="text-white my-2 w-full md:w-6/12">
                                                        <input
                                                            onChange={handleChange}
                                                            className="p-2 text-black w-full md:w-10/12 rounded-sm"
                                                            name="email"
                                                            type="email"
                                                            placeholder="email 📪"
                                                        />
                                                    ...
                                                    <div className="py-4 w-full text-center md:w-1/12 md:text-left">
                                                        <button
                                                            ...
                                                            className="border px-12 md:px-4 rounded-xl text-md text-white hover:rounded-md hover:px-6 transition-all"
                                                        >
                                                            Submit
                                                        </button>
                                                    </div>
                                            ...
                                            <div className="mt-2 text-red-500">
                                                {' '}
                                                {authError && (
                                                    <p>Authentication failed. {authMsg}</p>
                                                )}
                                            </div>
                                        </form>
                                    </div>
            ...
            {showSubmitted && (
                <div className="bottom-8 -right-4 text-white absolute border rounded-bl-md  rounded-tl-md py-4 px-6 md:px-8 bg-white text-sm text-blue-900">
                    {' '}
                    Submitted 🤙
                </div>
            )}
